...
| программа                     | версия |
|-------------------------------|--------|
| [Django](https://django.fun/ru/docs/django/3.2/)                       | 3.2.16 |
| [pytest](https://pytest-docs-ru.readthedocs.io/ru/latest/)                        | 6.2.4  |
| [pytest-pythonpath](https://docs.pytest.org/en/latest/explanation/pythonpath.html)            | 0.7.3  |
| [pytest-django](https://pytest-django.readthedocs.io/en/latest/)                  | 4.4.0  |
| [djangorestframework](https://ilyachch.gitbook.io/django-rest-framework-russian-documentation/overview/readme)           | 3.12.4 |
| [djangorestframework-simplejwt](https://django-rest-framework-simplejwt.readthedocs.io/en/latest/) | 4.7.2  |
| [Pillow](https://python-scripts.com/pillow)                        | 9.3.1  |
| [PyJWT](https://pyjwt.readthedocs.io/en/stable/)                         | 2.1.0  |
| [requests](https://pythonru.com/biblioteki/kratkoe-rukovodstvo-po-biblioteke-python-requests)                     | 2.26.0 |
| [djoser](https://pypi.org/project/djoser/)                        | 2.2.0  |

### **Запускаем проект в dev режиме на OC Windows**
Клонировать репозиторий с GitHub
```
git clone git@github.com:ValeryKorobov/api_final_yatube.git
```
...
###### Общая документация к проекту
Ссылка -> http://127.0.0.1:8000/redoc/

### **Автор**
[Валерий Коробов](https://github.com/ValeryKorobov) - Python-разработчик